...
# EDA Part 1 - Case Metadata

In this section, we will be analyzing the Case Dataset: calcification and mass datasets containing patient, abnormality, BI-RADS assessment, image image_view, breast density, subtlety, and pathology (diagnosis) information. The purpose of this EDA is three-fold:
...
The dataset dictionary is outlined in {numref}`eda1_case_dataset`.
...
Samples from the dataset are as follows:
