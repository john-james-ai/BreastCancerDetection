...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.12                                                                             #
# Filename   : /bcd/model/network/nlnetv4.py                                                       #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Wednesday February 21st 2024 04:46:26 pm                                            #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
# ------------------------------------------------------------------------------------------------ #
@dataclass
class NLNetV4Config(NetworkConfig):
    """NLNetV4 configuration"""
...
#                                       NLNetV4 FActory                                            #
# ------------------------------------------------------------------------------------------------ #
class NLNetV4Factory(NetworkFactory):
    """Factory for CNN NLNetV4 Transfer Learning model"""

    __name = "NLNetV4"

    def __init__(
        self,
        config: NLNetV4Config,
    ) -> None:
        self._config = config
